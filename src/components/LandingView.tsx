              ...
              <div className="p-4 rounded-2xl bg-white/10 border border-emerald-400/30 backdrop-blur-md space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-white/15 hover:bg-white/25 text-white font-bold text-sm sm:text-base border border-white/20 backdrop-blur-xs transition cursor-pointer"
                  >
