              ...
              <div className="p-4 rounded-2xl bg-white/10 border border-emerald-400/30 backdrop-blur-md space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-3.5 rounded-xl bg-white hover:bg-stone-50 text-stone-900 font-bold text-sm sm:text-base shadow-md transition active:scale-98 cursor-pointer"
                  >
                    ...
                    <span>
                      {language === 'hi'
                        ? 'डेटा साझा करें और जारी रखें (Google)'
                        : language === 'mr'
                        ? 'डेटा शेअर करा आणि पुढे चला (Google)'
                        : 'Share Data & Continue with Google'}
                    </span>
                  </button>
